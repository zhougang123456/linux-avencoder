...
{   
    ...
    frmArgb->format = AV_PIX_FMT_ARGB;
    ret = av_frame_get_buffer(frm420p, 1);
    if (ret < 0) {
...
{   
    av_image_fill_arrays(frmArgb->data, frmArgb->linesize, buffer, AV_PIX_FMT_ARGB, context->width, context->height, 4);
